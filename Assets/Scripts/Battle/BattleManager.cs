...
//     private EnemyController _enemyComponent;
//     
...
//         _enemyComponent = _enemy.GetComponent<EnemyController>();
//     }
//
...
//     {
//         _abilityButtons[buttonIndex].SetActive(PlayerController.Instance.Abilities[buttonIndex].IsUnlocked);
//         _abilityButtons[buttonIndex].GetComponent<Button>().onClick.AddListener(() => PlayerController.Instance.Abilities[buttonIndex].Activate(_player.GetComponent<PlayerController>(), _enemy.GetComponent<EnemyController>()));
//         _abilityButtons[buttonIndex].GetComponent<Button>().onClick.AddListener(() => UpdateButtonText(_abilityButtons[buttonIndex], PlayerController.Instance.Abilities[buttonIndex]));
//         _abilityButtons[buttonIndex].GetComponentInChildren<TMP_Text>().text = PlayerController.Instance.Abilities[buttonIndex].ToString();
//     }
//
...
//     {
//         while (!PlayerController.Instance.IsDead && !_enemyComponent.IsDead)
//         {
